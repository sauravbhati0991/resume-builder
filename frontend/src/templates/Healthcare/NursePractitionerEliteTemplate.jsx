...
export default function NursePractitionerEliteTemplate({ templateId, saveResume, downloadResume, initialData }) {
        ...
        <div className="grid lg:grid-cols-2 gap-6 h-full">
            ...
            <div className="h-full overflow-y-auto pr-2 custom-scrollbar pb-20 space-y-6">
                     ...
                     {data.experience.map((exp, i) => (
                        <div key={i} className="mb-4 p-4 border rounded-lg bg-gray-50 relative group">
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                ...
                                <InputGroup label="Facility/Hospital" name="company" value={exp.company} onChange={(e)=>handleArrayChange(i,'experience',e)}/>
                ...
                <div className="bg-white rounded-xl shadow p-6 border border-gray-200">
                    ...
                    <InputGroup label="Education (supports multiline)" name="education" value={data.education} onChange={handleInputChange}/>
                </div>
            </div>
