      ...
      {showReplaceModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-4">
          <div className="w-full max-w-md rounded-2xl bg-white p-6 shadow-2xl">
            <h3 className="text-lg font-bold text-gray-900 mb-2">Update Record?</h3>
            <p className="text-sm text-gray-600 mb-6">This will update your resume on our server and refresh the generated PDF.</p>
      ...
      {showSuccessModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 px-4">
          <div className="w-full max-w-md rounded-2xl bg-white p-6 shadow-2xl text-center">
            ...
            <p className="text-sm text-gray-600 mb-6">Your resume ID is: <strong>{generatedCvNumber}</strong></p>
