...
export default function PhysicalTherapistProTemplate({ templateId, saveResume, downloadResume, initialData }) {
        ...
        <div className="grid lg:grid-cols-2 gap-6 h-full">
            ...
            <div className="h-full overflow-y-auto pr-2 custom-scrollbar pb-20 space-y-6">
                     ...
                     {data.experience.map((exp, i) => (
                        <div key={i} className="mb-4 p-4 border rounded-lg bg-gray-50 relative group">
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                ...
                                <InputGroup label="Clinic/Hospital" name="company" value={exp.company} onChange={(e)=>handleArrayChange(i,'experience',e)}/>
                ...
                <div className="bg-white rounded-xl shadow p-6 border border-gray-200">
                    ...
                    <InputGroup label="Specialized Skills" name="skills" value={data.skills} onChange={handleInputChange}/>
