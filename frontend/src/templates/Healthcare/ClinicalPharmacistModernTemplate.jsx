...
export default function ClinicalPharmacistModernTemplate({ templateId, saveResume, downloadResume, initialData }) {
                     ...
                     {data.experience.map((exp, i) => (
                        <div key={i} className="mb-4 p-4 border rounded-lg bg-gray-50 relative group">
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                ...
                                <InputGroup label="Facility" name="company" value={exp.company} onChange={(e)=>handleArrayChange(i,'experience',e)}/>
