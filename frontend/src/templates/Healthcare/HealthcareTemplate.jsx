...
export default function HealthcareTemplate({ templateId, saveResume, downloadResume, initialData }) {
        ...
        <div className="bg-white/80 backdrop-blur-sm border border-gray-200/60 shadow-lg rounded-xl p-4">
          <div className="flex justify-between items-center">
            ...
            <div className="flex items-center gap-2">
              ...
              <button onClick={downloadPDF} className="inline-flex items-center justify-center text-sm font-medium h-9 px-4 rounded-md text-white shadow-md transition-opacity hover:opacity-90" style={{ backgroundColor: '#2F4F4F' }}>
        ...
        <div className="grid lg:grid-cols-2 gap-6 h-full">
          ...
          <div className="h-full overflow-hidden flex flex-col">
            ...
            <div className="bg-gray-50 p-6 flex justify-center items-start overflow-auto flex-1 custom-scrollbar">
              ...
              >
                <div ref={previewRef} className="h-full w-full bg-white p-10 font-sans text-slate-800">
