...
export default function EducationTemplate({ templateId, saveResume, downloadResume, initialData }) {
                  ...
                  {data.experience.map((exp, index) => (
                    <div key={index} className="p-4 bg-gray-50 rounded-lg border border-gray-100 relative group">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                        ...
                        <InputGroup label="School/Institution" name="company" value={exp.company} onChange={(e)=>handleArrayChange(index,'experience',e)}/>
