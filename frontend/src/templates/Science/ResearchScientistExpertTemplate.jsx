...
export default function ResearchScientistExpertTemplate({ templateId, saveResume, downloadResume, initialData }) {
            ...
            <div className="h-full overflow-y-auto pr-2 custom-scrollbar pb-20 space-y-6">
                <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-200">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <InputGroup label="Principal Title" name="title" value={data.title} onChange={handleInputChange} className="col-span-2"/>
                        ...
                        <InputGroup label="Research Hub" name="location" value={data.location} onChange={handleInputChange} className="col-span-2"/>
                    </div>
                </div>

                <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-200">
                    <h3 className="text-lg font-bold mb-4 flex items-center gap-2"><BookOpen size={20} className="text-[#008080]"/> Executive Abstract</h3>
                    <textarea rows={4} value={data.summary} id="summary" name="summary" onChange={handleInputChange} className="w-full border rounded-md p-3 text-sm focus:ring-2 focus:ring-[#008080] outline-none bg-slate-50/50 italic"/>
                </div>
                ...
                <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-200">
                    ...
                    <InputGroup label="Methodologies (Comma separated)" name="skills" value={data.skills} onChange={handleInputChange}/>
                    <div className="h-4"></div>
                    <InputGroup label="Academic Degrees" name="education" value={data.education} onChange={handleInputChange}/>
                </div>
            </div>
