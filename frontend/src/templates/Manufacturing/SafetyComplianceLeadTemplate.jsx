...
export default function SafetyComplianceLeadTemplate({ templateId, saveResume, downloadResume, initialData }) {
        ...
        <div className="grid lg:grid-cols-2 gap-6 h-full">
            ...
            <div className="h-full overflow-y-auto pr-2 custom-scrollbar pb-20 space-y-6">
                ...
                <div className="bg-white rounded-xl shadow p-6 border border-gray-200">
                    ...
                    <textarea rows={4} value={data.summary} id="summary" name="summary" onChange={handleInputChange} className="w-full border rounded-md p-2 text-sm focus:ring-2 focus:ring-[#B7410E] outline-none"/>
                </div>
                <div className="bg-white rounded-xl shadow p-6 border border-gray-200">
                     ...
                     {data.experience.map((exp, i) => (
                        <div key={i} className="mb-4 p-4 border rounded-lg bg-gray-50 relative group">
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                ...
                                <textarea rows={3} value={exp.description} id="description" name="description" onChange={(e)=>handleArrayChange(i,'experience',e)} className="col-span-2 border rounded p-2 text-sm focus:ring-2 focus:ring-[#B7410E] outline-none"/>
                            </div>
                        </div>
                     ))}
                </div>
