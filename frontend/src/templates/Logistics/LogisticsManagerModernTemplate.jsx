...
export default function LogisticsManagerModernTemplate({ templateId, saveResume, downloadResume, initialData }) {
        ...
        <div className="grid lg:grid-cols-2 gap-6 h-full">
            ...
            <div className="h-full overflow-y-auto pr-2 custom-scrollbar pb-20 space-y-6">
                ...
                <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-200">
                    ...
                    <textarea rows={4} value={data.summary} id="summary" name="summary" onChange={handleInputChange} className="w-full border rounded-md p-3 text-sm outline-none focus:ring-2 focus:ring-[#808000] bg-gray-50/30"/>
                </div>
                ...
                <div className="bg-white rounded-xl shadow-sm p-6 border border-gray-200">
                    ...
                    <InputGroup label="Logistics Skills (Comma separated)" name="skills" value={data.skills} onChange={handleInputChange}/>
                    <div className="h-4"></div>
                    <InputGroup label="Education & Certificates" name="education" value={data.education} onChange={handleInputChange}/>
                </div>
            </div>
